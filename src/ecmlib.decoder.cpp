...
namespace ecmlib
{
                                       ...
                                       uint16_t outBufferSize, sector_type sectorType, uint16_t sectorNumber, optimizations opts)
    {
        ...
        case ST_CDDA_GAP:
            ...
            if (sectorType == ST_CDDA || !std::to_underlying(opts & optimizations::OO_REMOVE_GAP))
            {
        ...
        case ST_MODE1_GAP:
            ...
            if (sectorType == ST_MODE1 || sectorType == ST_MODE1_RAW || !std::to_underlying(opts & optimizations::OO_REMOVE_GAP))
            {
        ...
        case ST_MODE2_GAP:
            ...
            if (sectorType == ST_MODE2 || !std::to_underlying(opts & optimizations::OO_REMOVE_GAP))
            {
        ...
        case ST_MODE2_XA_GAP:
            ...
            if (sectorType == ST_MODE2_XA1 || !std::to_underlying(opts & optimizations::OO_REMOVE_GAP))
            {
        ...
        case ST_MODE2_XA2_GAP:
            ...
            if (sectorType == ST_MODE2_XA2 || !std::to_underlying(opts & optimizations::OO_REMOVE_GAP))
            {
        ...
        case sector_type::ST_MODE1_GAP:
            ...
            if (sectorType == sector_type::ST_MODE1_RAW || !std::to_underlying(opts & optimizations::OO_REMOVE_EDC))
            {
        ...
        {
            if (sectorType == sector_type::ST_MODE1_RAW || !std::to_underlying(opts & optimizations::OO_REMOVE_BLANKS))
            {
        ...
        {
            if (sectorType == sector_type::ST_MODE1_RAW || !std::to_underlying(opts & optimizations::OO_REMOVE_ECC))
            {
    ...
    std::vector<char> inline decoder::sector_to_time(uint32_t sectorNumber) const
    {
